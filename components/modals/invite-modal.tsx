        ...
        <Dialog open={isModalOpen} onOpenChange={onClose}>
            <DialogContent className="bg-white text-black p-0, overflow-hidden" > 
                <DialogHeader className="pt-8 px-6"> 
                    ...
                    <div className="p-6">
                        <Label className="uppercase text-xs font-bold text-zinx-500 dark:text-secondary/70"> 
                            Community Invite Link     
                        </Label> 
                        <div className="flex items-center mt-2 gap-x-2">
                            <Input disabled={isLoading} className="bg-zinc-300/50 bold border-0 focus-visible:ring-0 text-black focus-visible:ring-offset-0 "
                                value={inviteUrl}
                            />
